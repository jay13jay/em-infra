...
- [ ] Required bootstrap outputs exist and are documented.
- [ ] Output names avoid ambiguous or environment-specific shortcuts.
...
- Open questions: Should VM IDs be included in mandatory or optional output set?
